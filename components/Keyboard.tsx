...
export const Keyboard: React.FC<KeyboardProps> = ({ guessedLetters, onGuess, disabled }) => {
  return (
    <div className="flex flex-wrap justify-center gap-2 max-w-4xl mx-auto p-4">
      {LETTERS.map((letter) => {
        ...
        return (
          <button
            ...
            className={`
              w-10 h-10 md:w-12 md:h-12 rounded-lg font-bold text-lg md:text-xl shadow-sm transition-all
              ${isUsed 
